...
#define PFX "ov8858_camera_sensor"
#define LOG_1 LOG_INF("ov8858,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = ov8858_SENSOR_ID, //ov8858_SENSOR_ID,
   	 ...
   	 {   
   	    	reg_gain = 0x10 * gain/BASEGAIN ;        //change mtk gain base to aptina gain base
   	    	 ...
   	    	 if(reg_gain<=0x10)
   	    	 {
   	    	    	...
   	    	    	write_cmos_sensor(0x01, 0x01);
 //  	    	    	LOG_INF("ov8858 reg_gain =%d, ov8858MIPI Gain = %d", reg_gain, gain);
   	    	 }
   	    	 else if(reg_gain>= 0x70)
   	    	 {
   	    	    	 ...
   	    	    	 write_cmos_sensor(0x01, 0x01);
  // 	    	    	 LOG_INF("ov8858MIPI reg_gain =%d, ov8858MIPI Gain = %d",  reg_gain, gain);
	        }        	
   	    	 else
   	    	 {
   	    	    	 write_cmos_sensor(0xfd, 0x01);
