...
#define LOG_1 LOG_INF("ov2680,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = ov2680_SENSOR_ID, //ov2680_SENSOR_ID,
   	 ...
   	 {   
   	    	reg_gain = 0x10 * gain/BASEGAIN ;        //change mtk gain base to aptina gain base
   	    	 ...
   	    	 if(reg_gain<=0x10)
   	    	 {
   	    	    	...
   	    	    	write_cmos_sensor(0x01, 0x01);
 //  	    	    	LOG_INF("ov2680 reg_gain =%d, ov2680MIPI Gain = %d", reg_gain, gain);
   	    	 }
   	    	 else if(reg_gain>= 0x70)
   	    	 {
   	    	    	 ...
   	    	    	 write_cmos_sensor(0x01, 0x01);
  // 	    	    	 LOG_INF("ov2680MIPI reg_gain =%d, ov2680MIPI Gain = %d",  reg_gain, gain);
	        }        	
   	    	 else
   	    	 {
   	    	    	 write_cmos_sensor(0xfd, 0x01);
