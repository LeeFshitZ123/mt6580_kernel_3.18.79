...
#include "gc2355mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = gc2355_SENSOR_ID, //gc2355_SENSOR_ID,
   	 ...
   	 {   
   	    	reg_gain = 0x10 * gain/BASEGAIN ;        //change mtk gain base to aptina gain base
   	    	 ...
   	    	 if(reg_gain<=0x10)
   	    	 {
   	    	    	...
   	    	    	write_cmos_sensor(0x01, 0x01);
 //  	    	    	LOG_INF("gc2355 reg_gain =%d, gc2355MIPI Gain = %d", reg_gain, gain);
   	    	 }
   	    	 else if(reg_gain>= 0x70)
   	    	 {
   	    	    	 ...
   	    	    	 write_cmos_sensor(0x01, 0x01);
  // 	    	    	 LOG_INF("gc2355MIPI reg_gain =%d, gc2355MIPI Gain = %d",  reg_gain, gain);
	        }        	
   	    	 else
   	    	 {
   	    	    	 write_cmos_sensor(0xfd, 0x01);
